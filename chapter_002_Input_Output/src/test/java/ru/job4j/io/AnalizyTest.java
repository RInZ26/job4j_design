...
public class AnalizyTest {
    ...
    public void whenLogHasTrashString() {
        listOfTestingRecords = Arrays.asList("### 32200 10:56:01",
                                             " 200 10:56:01", "200 10:56:01",
                                             "500 10:57:01", "400 10:58:01",
                                             "200 10:59:01", "ups 400 34:23:11",
                                             "500 11:01:02", "200 11:02:02");
    ...
    public void whenLogHasStartAndHasntFinishOfTroublePeriod() {
        listOfTestingRecords = Arrays.asList("200 12:02:12", "500 11:01:02",
                                             "400 11:22:11", "300 12:02:12",
                                             "500 11:01:02", "400 11:22:11");
        assertThat(checkThisData(listOfTestingRecords),
                   is("500 11:01:02 300 12:02:12 500 11:01:02 neverEnd"));
    }

    @Test
    public void whenLogHasAndOnlyErrorRecords() {
        listOfTestingRecords = Arrays.asList("400 12:02:12", "500 11:01:02",
                                             "400 11:22:11");
        assertThat(checkThisData(listOfTestingRecords),
                   is("400 12:02:12 neverEnd"));
    }

    @Test
    public void whenLogHasZeroErrorRecords() {
        listOfTestingRecords = Arrays.asList("200 12:02:12", "300 11:01:02",
                                             "100 11:22:11", "000 12:02:12",
                                             "800 11:01:02", "900 11:22:11");
