...
public class SimpleHashMap<K, V> implements Iterable<SimpleHashMap.Node<K, V>> {
    ...
    public Iterator<Node<K, V>> iterator() {
        ...
        return new Iterator<Node<K, V>>() {
             ...
             */
            Iterator<Node<K, V>> iteratorOfTheCurrentInnerLinkedList = Collections
                    .emptyIterator();
    ...
    public static class Node<K, V> implements Iterable<Node<K, V>> {
        ...
        public Iterator<Node<K, V>> iterator() {
            ...
            return new Iterator<Node<K, V>>() {
                 ...
                 */
                Node<K, V> pointerBeforeCurrentElement = new Node<>(
                ...
                public void remove() {
                    if (!removed) {
                        ...
                        removed = true;
                        Node<K, V> nextNodeForCurrentNode = hasNext()
                                ? pointerCurrentElement.next
                                : null;
